...
git branch -M main
git remote add origin git@github.com:sjvrijn/my_python_package
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/sjvrijn/repositories/new](https://github.com/organizations/sjvrijn/repositories/new)
and create a new repository named `my_python_package` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/sjvrijn/my_python_package/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
